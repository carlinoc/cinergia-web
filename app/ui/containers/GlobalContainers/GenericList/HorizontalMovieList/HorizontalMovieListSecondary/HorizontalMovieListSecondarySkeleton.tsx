export default function HorizontalMovieListSecondarySkeleton() {
  return (
    <section className="w-11/12 rounded-lg px-4 py-8 md:px-8 md:py-16 bg-dark-800 animate-pulse">
      <div className="grid grid-cols-1 md:grid-cols-6 justify-center items-center gap-10 w-full h-full rounded-md">
        ...
        <div className="col-span-1 md:col-span-4 w-full h-full rounded-md bg-dark-700" />
      </div>
    </section>
  );
}
